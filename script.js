...
function addMedRow(name = '', dosage = '', freq = '', duration = '') {
  ...
  row.innerHTML = `
    <td><input type="text" placeholder="Medicine name" value="${escapeHtml(name)}"></td>
    <td><input type="text" placeholder="10mg" value="${escapeHtml(dosage)}"></td>
    <td><input type="text" placeholder="Twice daily" value="${escapeHtml(freq)}"></td>
    <td><input type="text" placeholder="7 days" value="${escapeHtml(duration)}"></td>
    <td>
